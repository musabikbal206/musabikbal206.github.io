const langData = {
	en: {
		...
		quiz_header_subtitle: 'Best of Quizzes!',
		...
		about_mission_desc: 'Our mission is simple: to make complex English grammar rules accessible to everyone. We achieve this by providing carefully prepared tests the most common and challenging aspects of the language, from basic tenses and prepositions to advanced conditionals and inversions.',
	...
	tr: {
		...
		quiz_header_subtitle: 'Quiz mi,  en iyisi!',
		...
		about_mission_desc: 'Görevimiz basit: karmaşık İngilizce gramer kurallarını herkes için erişilebilir kılmak. Bunu, temel zamanlar ve edatlardan ileri düzey koşul cümlelerine ve devriklere kadar dilin en yaygın ve zorlu yönlerini kapsayan özenle hazırlanmış teslerle başarıyoruz.',
